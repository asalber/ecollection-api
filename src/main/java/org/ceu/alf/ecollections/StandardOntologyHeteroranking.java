...
/**
 * Class that implements an ontology heteroranking.
 * 
 * @author Alfredo Sánchez Alberca (asalber@ceu.es)
 *
 */
public class StandardOntologyHeteroranking implements OntologyHeteroranking {

  /**
   * 
   */
  public StandardOntologyHeteroranking() {
