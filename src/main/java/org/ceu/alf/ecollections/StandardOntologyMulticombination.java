...
/**
 * Class that implements an ontology multicombination.
 * 
 * @author Alfredo Sánchez Alberca (asalber@ceu.es)
 *
 */
public class StandardOntologyMulticombination implements OntologyMulticombination {

  /**
   * 
   */
  public StandardOntologyMulticombination() {
