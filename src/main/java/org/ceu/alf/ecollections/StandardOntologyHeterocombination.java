...
/**
 * Class that implements an ontology heterocombination.
 * 
 * @author Alfredo Sánchez Alberca (asalber@ceu.es)
 *
 */
public class StandardOntologyHeterocombination implements OntologyHeterocombination {

  /**
   * 
   */
  public StandardOntologyHeterocombination() {
