...
/**
 * Class that implements an ontology heterovariation.
 * 
 * @author Alfredo Sánchez Alberca (asalber@ceu.es)
 *
 */
public class StandardOntologyHeterovariation implements OntologyHeterovariation {

  /**
   * 
   */
  public StandardOntologyHeterovariation() {
